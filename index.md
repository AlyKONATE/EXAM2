...
## La dernière visualisation de données consiste à determiner la localisation de l'ensemble des établissements d'enseignement superieur avec Flourish et definir toutes les informations se rapportant à l'université( sa date de création, le numéro SIRET etc). Comme le montre cette représentation ci-dessous chaque institution d'enseignements regroupe un ensemble d'élèments  permettant en son identification.
